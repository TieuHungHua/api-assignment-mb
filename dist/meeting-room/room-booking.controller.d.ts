...
export declare class RoomBookingController {
    ...
    createBooking(dto: CreateBookingDto, currentUser: CurrentUserType): Promise<{
        id: string;
        room_id: string;
        user_id: string;
        start_at: string;
    ...
    searchBookings(criteria: BookingSearchCriteriaDto, req: RequestWithUser): Promise<{
        items: {
            id: string;
            room_id: string;
            user_id: string;
    ...
    getBooking(id: string, req: RequestWithUser): Promise<{
        id: string;
        room_id: string;
        user_id: string;
        start_at: string;
    ...
    cancelBooking(id: string, dto: CancelBookingDto, currentUser: CurrentUserType): Promise<{
        id: string;
        room_id: string;
        user_id: string;
        start_at: string;
